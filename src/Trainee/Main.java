		...
		public static void main(String[] args) {
			...
			for (Trainee e : tms.getTrainees()) {
			    if (e instanceof TechnicalTrainee) {
			        ...
			        System.out.println("Technical Trainee: Name: " + ftt.getName() + ", Age: " + ftt.getAge() + ", Address: " + ftt.getAddress()+",Gender:"+ftt.getGender()+ ", Course: " + ftt.getCourse() + ", Salary: " + ftt.getSalary() + ", Working Days: " + ftt.getWorkingDays());
			    } else if (e instanceof ManagementTrainee) {
			    	ManagementTrainee ptt = (ManagementTrainee) e;
			        System.out.println("Management Trainee: Name: " + ptt.getName() + ", Age: " + ptt.getAge() + ", Address: " + ptt.getAddress()+",Gender:"+ptt.getGender()+ ", Course: " + ptt.getCourse() + ", Salary: " + ptt.getSalary() + ", Working Days: " + ptt.getWorkingDays());
			    }
			}
